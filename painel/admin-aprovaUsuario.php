<?php 
	if (isset($_POST['aprovar'])) {
		...
		$aprovado = 1;
		if (Usuario::aprovarUsuario($aprovado,$idUsuario)) {
	...
	if (isset($_POST['recusar'])) {
		$idUsuario = $_POST['idUsuario'];
		if (Usuario::recusarUsuario($idUsuario)) {
...
<div class="row">
			<div class="col-lg-12">
				<h2 class="page-header">Aprovar Usuarios</h1>
			</div>
		</div>
		<!--/.row-->
<?php 
		$fornecedoresNAprovados = 0;
		$aprovarFornecedor = MySql::conectar()->prepare('SELECT * FROM `tb_admin.cadastro_usuarios` WHERE aprovado = ?');
	...
	<div class="container-editar container-wraper">
		...
		<div class="container-overflow">
			...
			<div class="container-single w33 left ">
				<span class="borderLeft">CPF: <?php echo $value['cpf']; ?></span>
